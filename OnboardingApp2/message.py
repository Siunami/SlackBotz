...
class Message(object):
    ...
    def __init__(self):
        ...
        self.channel = ""
        self.timestamp = ""
        self.text = ("Welcome to ___! We're so glad you're here. "
                     "\nGet started by completing the steps below in order.")
        self.emoji_attachment = {}
        self.pin_attachment = {}
        self.share_attachment = {}
        self.topic_attachment = {}
        self.introduction = {}
    ...
    def create_attachments2(self, json):
        """
        Open JSON message attachments file and create attachments for
        onboarding message. Saves a dictionary of formatted attachments on
        the bot object.
        """
        json_dict = yaml.safe_load(json)
        return json_dict
